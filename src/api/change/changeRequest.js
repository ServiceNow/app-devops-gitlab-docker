...
class ChangeRequestManager extends SnDevopsApi {
    ...
    _getRequestBodyForChangeCreation(changePayload, pipelineContext) {
        ...
        let payload = {
            ...
            "workflow": changePayload.workflow,
            "repository": changePayload.repository,
